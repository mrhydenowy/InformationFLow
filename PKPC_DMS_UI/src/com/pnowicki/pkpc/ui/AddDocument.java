...
public class AddDocument extends JFrame {
				...
				layout.createSequentialGroup()
						...
						.addGroup(
								layout.createParallelGroup(
										...
										.addComponent(nameDocumentField,
												GroupLayout.PREFERRED_SIZE,
						...
						.addPreferredGap(
								...
								Short.MAX_VALUE)
						.addComponent(addDocumentButton).addContainerGap()));
	...
	private void addDocumentButtonListener() {
		addDocumentButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				fdmp.bodyPart(new FileDataBodyPart("file", fileTmp,
						MediaType.APPLICATION_OCTET_STREAM_TYPE));
				fdmp.bodyPart(new FormDataBodyPart("fileName",
						getNameDocumentField));
				fdmp.bodyPart(new FormDataBodyPart("fileSignature",
						getSignatureField));
	...
	private void chooserFilesListener() {
		...
		chooseFileButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				// wywolujemy showOpenDialog bo bedziemy chcieli otworzyc plik.
				// w nawiasie dajemy gdzie ma sie wyswietlic. RootPane wyswietli
				// sie nam wzgledem ramki
				// przypisujemy zmienna int do tej funkcji i sprawdzamy jaka
				// liczbe zwroci ta funkcji gdy nacisniemy Open albo Cancel
